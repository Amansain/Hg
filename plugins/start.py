...
botid = token.split(':')[0]
FLOOD = 500
LAZY_PIC = os.environ.get("LAZY_PIC", "https://telegra.ph/file/65df62b72f17142d98438.jpg")
	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://t.me/andybotupdates")],
                                      [InlineKeyboardButton("🦋 Subscribe us 🦋", url="https://youtube.com/@Andyian_verse")],
                                      [InlineKeyboardButton("Support Group", url='https://t.me/andybotssupportgroup'),
                                      InlineKeyboardButton("Movie Channel", url='https://t.me/andymovies')],
                                      [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://pay.upilink.in/pay/amansain295@okhdfcbank?am=50')]
                                      ]))
        return
    if id:
        if old == True:
...
async def send_doc(client, message):
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton("🦋 Contact Developer 🦋", url='https://telegram.me/Aman_sain')],
                                                                     [InlineKeyboardButton("🔺 Watch Tutorial 🔺", url='https://youtube.com/@Andyian_verse')],
                                                                     [InlineKeyboardButton("🦋 Visit Channel  ", url='https://t.me/andymovies'),
                                                                     InlineKeyboardButton("  Support Group 🦋", url='https://t.me/andybotssupportgroup')],
                                                                     [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://pay.upilink.in/pay/amansain295@okhdfcbank?am=50')]
                                                                    ]))
        await message.reply_text(text=f"🦋")
